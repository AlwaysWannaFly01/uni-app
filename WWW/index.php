...
if($_GET['token'] != 'api2020'){exit(jsonCode('error', 'token error'));}
...
/* 数据库配置 */
define('HS_DB_HOST'    , 'localhost'); // mysql 服务器地址
define('HS_DB_NAME'    , 'yuedu');     // 数据库名称
define('HS_DB_USER'    , 'root');      // 数据库账号
define('HS_DB_PWD'     , '123456');      // 数据库密码
define('HS_DB_PRE'     , 'yuedu_');    // 数据表统一前缀
define('HS_DB_CHARSET' , 'utf8');   // mysql 字符集类型

/* 微信小程序相关设置  */
define('HS_APPID'  , 'wx0f06d8ff7985c699'); //小程序APPID
define('HS_SECRET' , '823b5ab6bb47c0b385826557df784b58');//小程序AppSecret(小程序密钥),开发设置里面生成
